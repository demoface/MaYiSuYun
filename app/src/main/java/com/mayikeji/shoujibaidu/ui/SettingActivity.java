        ...
        switch (v.getId()) {
            case R.id.btn_sub:
                ...
                if (!TextUtils.isEmpty(min_price.getText().toString()) && !TextUtils.isEmpty(max_price.getText().toString()) &&
                    ...
                    ShareUtils.putInt(getApplicationContext(), "min_price", Integer.valueOf(min_price.getText().toString()));
                    ShareUtils.putInt(getApplicationContext(), "max_price", Integer.valueOf(max_price.getText().toString()));

                    ShareUtils.putInt(getApplicationContext(), "min_dis", Integer.valueOf(min_dis.getText().toString()));
                    ShareUtils.putInt(getApplicationContext(), "max_dis", Integer.valueOf(max_dis.getText().toString()));
