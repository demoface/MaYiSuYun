...
import com.mayikeji.mayisuyun.helper.HttpHelper;
...
public abstract class QiangDanServer {
    ...
    public int[] getDis() {
        return new int[]{ClientApplication.sp.getInt("min_dis", 0), ClientApplication.sp.getInt("max_dis", Integer.MAX_VALUE)};
    }
